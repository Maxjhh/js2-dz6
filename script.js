//С прошлого дз изменилось немного, но всё есть, перетаскивание в корзину, каруселька
  ...
  $(function() {
    ...
    $.ajax({
      ...
      success: function(goods) {
        ...
        var prodsl = $('.prod').clone().insertAfter('h1').addClass('prodsl');
